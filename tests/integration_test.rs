...
async fn test_client_message_formats() {
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse connect message");
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse chat message");
    ...
    let json =
        serde_json::to_string(&disconnect_msg).expect("Failed to serialize disconnect message");
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse disconnect message");
...
async fn test_server_message_formats() {
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse server chat message");
    ...
    let json =
        serde_json::to_string(&user_list_msg).expect("Failed to serialize user list message");
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse user list message");
    ...
    let json =
        serde_json::to_string(&user_joined_msg).expect("Failed to serialize user joined message");
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse user joined message");
    ...
    let json =
        serde_json::to_string(&user_left_msg).expect("Failed to serialize user left message");
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse user left message");
...
async fn test_message_structure_validation() {
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse valid message");
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse empty message");
    ...
    let parsed: serde_json::Value =
        serde_json::from_str(&json).expect("Failed to parse long message");
